...
C {devices/lab_pin.sym} 170 170 3 1 {name=p9 sig_type=std_logic lab=Vbgr_parax
}
C {devices/res.sym} 170 200 0 0 {name=R2
value=11G
footprint=1206
device=resistor
m=1
}
C {devices/lab_pin.sym} 170 230 0 0 {name=p10 sig_type=std_logic lab=VSS
}
C {core_prel.sym} 20 180 0 0 {name=x2
